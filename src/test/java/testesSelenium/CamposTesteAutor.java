...
public class CamposTesteAutor {
	...
	public void localizarBotoesDel(){
		botaoCheckDel = driver.findElement(By.xpath("//*[@id=\"pn_id_471-table\"]/tbody/tr/td[1]/p-tablecheckbox/div/div[2]"));
		botaoDeletar =  driver.findElement(By.xpath("//*[@id=\"pn_id_471-table\"]/tbody/tr/td[4]/div[2]"));
	}
