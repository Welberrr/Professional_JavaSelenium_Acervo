...
public class CamposTesteLivro {
	...
	public void localizarBotaoEdit() {
		botaoEditLivro = driver.findElement(By.xpath("//*[@id=\"pn_id_433-table\"]/tbody/tr/td[9]/div[1]"));
	}
	...
	public void localizarBotaoAutor() {
		botaoAutor = driver.findElement(By.xpath("//*[@id=\"pn_id_466_content\"]/div/div/div[1]/input"));
	}
	...
	public void localizarBotaoExclusao() {
		botaoExclusao = driver.findElement(By.xpath("//*[@id=\"pn_id_523-table\"]/tbody/tr/td[9]/div[2]"));
	}
